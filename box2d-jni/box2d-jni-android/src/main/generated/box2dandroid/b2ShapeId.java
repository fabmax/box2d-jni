 ...
 */
public class b2ShapeId extends NativeObject {

    private static native int __sizeOf();
    public static final int SIZEOF = __sizeOf();
    public static final int ALIGNOF = 8;
    
    public static b2ShapeId wrapPointer(long address) {
        return address != 0L ? new b2ShapeId(address) : null;
    }
    
    public static b2ShapeId arrayGet(long baseAddress, int index) {
        if (baseAddress == 0L) throw new NullPointerException("baseAddress is 0");
        return wrapPointer(baseAddress + (long) SIZEOF * index);
    }
    
    protected b2ShapeId(long address) {
        super(address);
    }
     ...
     * @return Stack allocated object of b2ShapeId
     */
    public static b2ShapeId createAt(long address) {
        Raw.b2ShapeId_placed(address);
        b2ShapeId createdObj = wrapPointer(address);
     ...
     * @return Stack allocated object of b2ShapeId
     */
    public static <T> b2ShapeId createAt(T allocator, Allocator<T> allocate) {
    ...
    public static class Raw {
        public static native void b2ShapeId_placed(long address);
        public static native long b2ShapeId();
