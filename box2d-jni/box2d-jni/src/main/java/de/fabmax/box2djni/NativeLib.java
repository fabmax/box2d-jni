...
public abstract class NativeLib {
    ...
    public void load() throws IOException {
        String defaultLibPath = new File(System.getProperty("java.io.tmpdir"), "de.fabmax.box2d-jni" + File.separator + getVersion()).getAbsolutePath();
        String libTmpPath = System.getProperty("box2d.nativeLibLocation", defaultLibPath);
